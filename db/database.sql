...
--
-- Host: localhost
-- Generation Time: Jun 11, 2024 at 04:20 PM
...
CREATE TABLE `subscriptions` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `plan_id` enum('Basic','Standard','Premium') NOT NULL,
...
--
ALTER TABLE `messages`
  ADD CONSTRAINT `messages_ibfk_1` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE CASCADE;
